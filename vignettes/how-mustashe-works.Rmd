...
With the code now as a string, it is formatted using the `tidy_source()` function from ['formatR'](https://cran.r-project.org/web/packages/formatR/index.html).
...
The hashing is handled by the ['digest'](https://cran.r-project.org/web/packages/digest/index.html) package.
